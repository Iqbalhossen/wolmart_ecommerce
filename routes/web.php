...
Route::middleware(['auth:admin'])->group(function(){
    ...
    Route::prefix('admin/brands')->group(function(){
        ...
        Route::prefix('admin/role')->group(function(){
            ...
            Route::get('/add',[AdminProfileController::class, 'Add_admin'])->name('add-admin');
            Route::post('/store',[AdminProfileController::class, 'store_admin'])->name('admin.role.store');
            Route::get('/manage',[AdminProfileController::class, 'Manage_Admin'])->name('manage-admin');
            Route::get('/edit/{id}',[AdminProfileController::class, 'Edit_Admin'])->name('edit.admin');
            Route::post('/update',[AdminProfileController::class, 'Update_admin'])->name('admin.role.update');
            Route::get('/delete/{id}',[AdminProfileController::class, 'Delete_Admin'])->name('delete.admin');
            Route::get('/view/{id}',[AdminProfileController::class, 'View_Admin'])->name('view.admin');
            Route::get('/inactive/{id}', [AdminProfileController::class, 'AdminInactive'])->name('admin.inactive');
            Route::get('/active/{id}', [AdminProfileController::class, 'AdminActive'])->name('admin.active');

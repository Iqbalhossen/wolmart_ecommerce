...
@if($adminData->show_by_brand == 1)
	  ...
	  <div class="container-full">
        ...
        <h3 class="box-title"> Product Show By Brand List <span class="badge badge-pill badge-danger"> {{ count($brand) }} </span></h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					  ...
					  <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($brand as $items)
							<tr>
								...
								<td width="20%">
                                    <a href=" {{ route('brand.show.store',$items->id) }} " class="btn btn-info" title="show">
                                        Show
                                    </a>

		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			...
			<div class="box-body">
             ...
             <input  type="hidden" name="old_id" value="{{ $about->id }}" >
...
<div class="row"> <!-- start 8th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	<textarea id="editor1" name="about_en" rows="" cols=""  >{{ $about->about_en }}</textarea>  
	 		 </div>
		</div>
...
<div class="form-group">
    ...
    <div class="controls">
<textarea id="editor2" name="about_others" rows="" cols=""  >{{ $about->about_others }}</textarea>  
      </div>
</div>

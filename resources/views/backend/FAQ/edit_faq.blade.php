...
<div class="container-full">
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					...
					<form   action="{{ route('update.faq') }}"  method="post"   novalidate="">
							...
							<div class="row"> <!-- Start 6th row -->
								...
								<div class="form-group">
										<label for="wlastName2"> Question Name English : <span class="danger">*</span> </label>
											<div class="controls">
												<input type="text" name="question_en" value="{{ $faq->question_en }}" class="form-control" > 
								...
								<div class="form-group">
										<label for="wlastName2">Question Name Others : <span class="danger">*</span> </label>
											<div class="controls">
												<input type="text" name="question_others" value="{{ $faq->question_others }}" class="form-control" > 
													<div class="help-block">
											...
											<div class="row"> <!-- Start 10th row -->
												...
												<div class="form-group">
														<label for="wlastName2">Answer Name English : <span class="danger">*</span> </label>
															<div class="controls">
															<textarea id="editor1" name="answer_en" rows="10" cols="80">{!! $faq->answer_en !!}</textarea>
																	<div class="help-block">
																		@error('answer_en')
																		<span class="text-danger">{{ $message }} </span>
																		@enderror
												...
												<div class="form-group">
														<label for="wlastName2">Answer Name Others : <span class="danger">*</span> </label>
															<div class="controls">
															<textarea id="editor2" name="answer_others" rows="10" cols="80">{!! $faq->answer_others !!}</textarea>
																	<div class="help-block">
																		@error('answer_others')
																		<span class="text-danger">{{ $message }} </span>
																		@enderror
		...
		<hr>
                        ...
                        <div class="form-group"> 
                            <input type="submit"    class="btn btn-primary mt-5 mb-5" value="Update FAQ" >
                        </div>

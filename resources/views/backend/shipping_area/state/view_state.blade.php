...
<div class="form-group">
	...
	<div class="controls">
		<select name="division_id" class="form-control"  >
			...
			<option value="{{ $div->id }}">{{ $div->division_name_en }}</option>	
			@endforeach
		</select>
		@error('division_id') 
...
<div class="form-group">
    ...
    <div class="form-group">
		<h5>State Name  <span class="text-danger">*</span></h5>
		<div class="controls">
	 <input type="text"  name="state_name_others" class="form-control" > 

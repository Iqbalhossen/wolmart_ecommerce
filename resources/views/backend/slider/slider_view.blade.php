...
<!--   ------------ Add Slider Page -------- -->
 ...
 <form method="post" action="{{ route('slider.store') }}" enctype="multipart/form-data">
	...
	<div class="form-group">
		<h5>Slider background Image(1903*520) <span class="text-danger">*</span></h5>
		<div class="controls">
	 <input type="file" name="slider_img_back" class="form-control" >
     @error('slider_img_back') 
	...
	<div class="form-group">
		<h5>Slider Image(480*633) <span class="text-danger">*</span></h5>
		<div class="controls">

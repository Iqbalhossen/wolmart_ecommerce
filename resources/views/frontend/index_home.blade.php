...
@foreach($sliders as $slider)
                    ...
                    <div class="banner banner-fixed intro-slide intro-slide2"
                        style="background-image: url({{asset($slider->slider_img_back)}}); background-color: #ebeef2; background-size:100% auto; background-position:center;" >
                        <div class="container">
                            ...
                            <div class="banner-content d-inline-block y-50">
                                <h5 class="banner-subtitle font-weight-normal text-default ls-50 "
                                ...
                                <p class="font-weight-normal text-default " data-animation-options="{
                                    'name': 'fadeInUpShorter',
                                    'duration': '1s',
                                    'delay': '.8s'
                                }">

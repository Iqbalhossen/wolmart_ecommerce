					...
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								...
								<h3 class="text-white mb-0 font-weight-500">${{ $today }} <small class="text-success"><i class="fa fa-caret-down"></i> usd</small></h3>
							</div>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-6">
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								<p class="text-mute mt-20 mb-0 font-size-16"> Montly Seles </p>
								<h3 class="text-white mb-0 font-weight-500">${{ $month }} <small class="text-success"><i class="fa fa-caret-down"></i>usd</small></h3>
							</div>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-6">
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								<p class="text-mute mt-20 mb-0 font-size-16">Year Seles</p>
								<h3 class="text-white mb-0 font-weight-500">${{ $year }} <small class="text-success"><i class="fa fa-caret-down"></i>usd</small></h3>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="table-responsive">
								<table class="table no-border">
									...
									<tr class="text-uppercase bg-lightest">
										...
										<th style="min-width: 120px"><span class="text-fade">Invoice</span></th>

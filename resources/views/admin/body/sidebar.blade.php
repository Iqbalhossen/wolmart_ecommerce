...
<aside class="main-sidebar">
    ...
    <section class="sidebar">	
     ...
     <li class="treeview">
        ...
        @if($adminData->show_by_category == 1)
        <li class="treeview">
          <a href="">
            <i data-feather="file"></i>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('add-admin') }}"><i class="ti-more"></i> Add Admin</a></li>
            <li><a href="{{ route('manage-admin') }}"><i class="ti-more"></i> Manage Admin</a></li>
